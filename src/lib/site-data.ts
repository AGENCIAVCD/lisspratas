...
export const registrationUrl =
  "https://chat.whatsapp.com/CigYzI98xKm67uGYAzI95F?mode=gi_t";
export const vipGroupUrl =
  "https://chat.whatsapp.com/CigYzI98xKm67uGYAzI95F?mode=gi_t";

export const navigationLinks = [
  { label: "Nova fase", href: "#historia" },
  { label: "Para quem é", href: "#beneficios" },
  { label: "Vantagens", href: "#starter-kit" },
...
export const authorityPoints = [
  ...
  },
  {
    ...
    description:
      "Tudo já nasce pronto para fortalecer sua divulgação no Instagram, no WhatsApp e no atendimento.",
  },
  {
...
export const footerLinks = [
  ...
  { label: "Catálogo", href: registrationUrl },
];
